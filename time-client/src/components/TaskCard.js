...
const TaskCard = (props) => {
    ...
    return (
        <div className="task-card">
          ...
          <p style={{padding: "5px"}} onClick={e => props.history.push(`tasks/${props.task.id}`)}><b>{props.task.title}</b><br/></p>
          <p style={{padding: "5px"}}>{props.task.description || props.description}</p>
